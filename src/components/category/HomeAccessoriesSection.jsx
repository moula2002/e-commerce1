...
function HomeAccessoriesSection() {
  ...
  // ✅ Inline Styles (same as Fashion section)
  const styles = {
    imageContainer: {
      width: "100%",
      height: "250px",
  ...
  // 👜 Fetch random accessories products
  useEffect(() => {
    const fetchRandomAccessories = async () => {
      setLoading(true);
      try {
        ...
        console.error("🔥 Error fetching random accessories:", err);
      } finally {
        setLoading(false);
      }
    };

    fetchRandomAccessories();
  }, []);

  return (
    <Container className="my-5 text-center">
      <h3 className="fw-bold text-dark mb-4">Trending Accessories 👜</h3>
