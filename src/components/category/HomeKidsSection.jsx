// src/components/category/HomeKidsSection.jsx
...
// 🎨 DEFINE CONSTANTS FOR MODERN AESTHETICS (Matching Accessories)
...
// 🎨 Custom CSS for this component (HEIGHT REDUCED & MOBILE OPTIMIZED - MATCHING ACCESSORIES)
const customStyles = {
...
    fontWeight: "900",
    color: PRIMARY_TEXT_COLOR,
    letterSpacing: "-1.5px", // ⬇️ REDUCED LETTER SPACING (was -1.8px)
    display: "inline-block",
    position: "relative",
    paddingBottom: "12px", // ⬇️ REDUCED PADDING (was 18px)
  },
  headerUnderline: {
    content: '""',
    position: "absolute",
...
    width: "100px", // ⬇️ REDUCED WIDTH (was 120px)
    height: "3px", // ⬇️ REDUCED HEIGHT (was 4px)
...
  },
  // HOVER STYLE - MATCHING ACCESSORIES
  viewDealButtonHover: {
    backgroundColor: SALE_COLOR, // Change to SALE_COLOR on hover for Kids too (more attractive)
...
    boxShadow: `0 5px 15px ${ACCENT_COLOR}60`, // 📱 MOBILE: Reduced shadow (was 0.8 25)
  },
};

// 💅 Hover Effects Logic (ADJUSTED FOR LESS LIFT/SHADOW - MATCHING ACCESSORIES)
...
// Dummy fallback (Price ranges adjusted to match Accessories section feel)
const generateDummyProduct = (index) => {
  const basePrice = Math.floor(Math.random() * 800) + 1500; // Adjusted base price to match Accessories section feel
...
  return {
    id: `kids-dummy-${index}`,
    name: `Adorable Kids Wear ${index + 1}`,
    brand: "KIDS TRENDZ",
    price: finalPrice,
...
  useEffect(() => { // ✅ ADDED resize listener
...
            TRENDING KIDS <span style={{ color: ACCENT_COLOR }}>FASHION</span>
...
            Trendy and comfy outfits your kids will love!
          </p>
        </div>
...
            <p className="mt-2 text-muted fs-6">Loading Kids collection...</p>
          </div>
        ) : (
          <>
