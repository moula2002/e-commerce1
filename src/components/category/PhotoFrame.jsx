// src/components/category/PhotoFrame.jsx
        ...
        <Card className="h-100 border-0" style={cardStyle}>
          ...
          <Card.Body>
            <Card.Title className="fs-6 text-truncate text-dark">
              {product.name || "Untitled Photo Frame"}
            </Card.Title>
...
// 📝 PhotoFrame Page with Infinite Scroll
function home() {
  const categoryName = "PhotoFrame";
  ...
  return (
    <Container className="my-5 text-center">
      <h2 className="fw-bold text-dark mb-4">{categoryName} 🖼️</h2>
