// src/components/HomeFashionSection.jsx
...
// 🎨 Custom CSS (Same as HomeAccessoriesSection)
const customStyles = {
  sectionContainer: {
...
// Hover Effects (same as Accessories)
...
  // This ensures the data fetching only happens ONCE when the component mounts.
  // This satisfies the requirement: it reloads only when the page is manually
  // reloaded (causing the component to remount).
  useEffect(() => {
...
        // Ensure we have exactly 4 products, filling with dummies if needed
