// src/components/category/HomePersonalCareSection.jsx
...
function HomePersonalCareSection() {
  ...
  useEffect(() => {
    const fetchPersonalCareProducts = async () => {
      try {
        ...
        console.error("Error fetching Personal Care preview:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <Container className="my-5 text-center">
      <h3 className="fw-bold text-dark mb-4">Featured Personal Care Products 🧴</h3>
