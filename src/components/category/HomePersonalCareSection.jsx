...
const generateDummyProduct = (index) => {
  ...
  if (guaranteedOriginalPrice <= guaranteedFinalPrice) {
    guaranteedOriginalPrice = guaranteedFinalPrice + Math.floor(Math.random() * 500) + 200;
  }

  return {
    id: `personal-care-dummy-${index}`,
    name: `Top Personal Care ${index + 1}`,
      ...
      <Container className="py-5" style={customStyles.sectionContainer}>
        ...
        <div className="text-center mb-5">
          <h3 style={customStyles.header}>
            PERSONAL CARE <span style={{ color: ACCENT_COLOR }}>ON SALE</span>
